...
*Because emails are frequently addressed to multiple people, we save the email addreses and their adress type ("to", "cc", "bcc") on a seperate join table.
...
We are always interested in support and feedback.  Please feel free to contact us at "team@gmailytics.com".